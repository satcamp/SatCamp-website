...
const button = tv({
  base: "inline-flex appearance-none items-center justify-center rounded-3xl font-medium outline-none ring-focus ring-offset-2 ring-offset-surface transition-transform duration-100 disabled:pointer-events-none disabled:opacity-50 data-[pressed]:scale-[.97] data-[hovered]:bg-primary/70 data-[focus-visible]:ring-2",
  variants: {
    intent: {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      state: "outline",
      class:
        "text-primary-content border border-primary bg-transparent data-[hovered]:bg-primary data-[hovered]:text-primary-fg",
    },
    {
      intent: "secondary",
      state: "ghost",
