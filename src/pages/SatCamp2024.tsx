  ...
  return (
    <>
      <Section dark>
        ...
        <RightColumn>
          <SubSectionTitle>Themes 2024</SubSectionTitle>
      ...
      <Section>
        <LeftColumn>
          <SectionTitle>Agenda 2024</SectionTitle>
        </LeftColumn>
        <RightColumn>
          ...
          <List>
            ...
            <Item>6:30pm Happy Hour at Avanti Rooftop</Item>
          </List>
      ...
      <Section dark id="lightning-talks">
        <LeftColumn>
          <SectionTitle>Lightning Talks 2024</SectionTitle>
      </LeftColumn>
      <RightColumn>
